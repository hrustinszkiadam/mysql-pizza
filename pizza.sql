...
ALTER TABLE rendeles ADD CONSTRAINT FOREIGN KEY (vazon) REFERENCES vevo(vazon) ON DELETE CASCADE;
ALTER TABLE rendeles ADD CONSTRAINT FOREIGN KEY (fazon) REFERENCES futar(fazon) ON DELETE CASCADE;
ALTER TABLE tetel ADD CONSTRAINT FOREIGN KEY (razon) REFERENCES rendeles(razon) ON DELETE CASCADE;
ALTER TABLE tetel ADD CONSTRAINT FOREIGN KEY (pazon) REFERENCES pizza(pazon) ON DELETE CASCADE;
